...
from . import agentNodeType, nodeIOSchema, nodePosition
...
class AgentNode(BaseModel):
    ...
    nodeType: Annotated[
        Optional[agentNodeType.AgentNodeType],
        Field(None, description='Type of the node'),
    ]
    ...
    inputSchema: Annotated[
        Optional[nodeIOSchema.NodeIOSchema],
        Field(None, description='Input Schema for Node'),
    ]
    outputSchema: Annotated[
        Optional[nodeIOSchema.NodeIOSchema],
        Field(None, description='Output Schema for Node'),
    ]
