...
class Skill(BaseModel):
    ...
    id: Annotated[Uuid, Field(description='Unique ID of the Skill')]
    name: Annotated[EntityName, Field(description='A unique name of the Skill')]
    fullyQualifiedName: Annotated[
    ...
    description: Annotated[
        Markdown, Field(description='Description of the Skill and its capabilities.')
    ]
    tools: Annotated[
        List[str], Field(description='List of tools that this skill depends on.')
    ]
    plugin: Annotated[
        Optional[EntityReference],
        Field(
            None,
            description='Reference to the Context Plugin that provides the tools for this skill.',
        ),
    ]
    provider: Annotated[
        ProviderType, Field(description='Provider of the Skill implementation')
    ]
    version: Annotated[
        Optional[EntityVersion],
    ...
    owners: Annotated[
        ...
        Field(None, description='Owners of this Skill.'),
    ]
    tags: Annotated[
        Optional[List[TagLabel]],
        Field([], description='Tags associated with the Skill.'),
    ]
    ...
    reviewers: Annotated[
        Optional[EntityReferenceList],
        Field(None, description='User references of the reviewers for this Skill.'),
    ]
    entityStatus: Annotated[
        Optional[Status], Field(Status.Approved, description='Status of the Skill.')
    ]
    followers: Annotated[
        Optional[EntityReferenceList],
