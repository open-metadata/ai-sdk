...
#   filename:  createAgentRequest.json
...
class ConversationHistoryDefinition(BaseModel):
    historyType: Annotated[
        Optional[ConversationHistoryType],
        Field(
            ConversationHistoryType.COUNT,
            description='The type of conversation history to be used.',
        ),
    ]
    count: Annotated[
        Optional[int],
        Field(
            0,
            description='The number of messages to fetch from the conversation history.',
        ),
    ]
...
class CreateAgentRequest(BaseModel):
    ...
    message: Annotated[str, Field(description='The message to be sent to the agent.')]
    agentType: Annotated[
        AgentTypeEnum, Field(description='The type of agent to be used.')
    ]
    agentMode: Annotated[AgentModeEnum, Field(description='The mode of the agent.')]
    conversationId: Annotated[Uuid, Field(description='The ID of the conversation.')]
    conversationHistory: Annotated[
        Optional[ConversationHistoryDefinition],
