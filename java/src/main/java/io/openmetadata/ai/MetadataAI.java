 ...
 * <p>
 * Use the {@link #builder()} method to create a new instance:
 * <pre>{@code
...
public class MetadataAI implements AutoCloseable {
    ...
    private MetadataAI(Builder builder) {
        this.httpClient = new MetadataHttpClient(
                builder.host,
                builder.token,
     ...
     * <p>
     * The returned handle can be used to invoke the agent synchronously,
     * with streaming, or to get agent information.
     *
     ...
     *
     * @param builder the builder containing agent configuration. 
     *                Persona and ability names will be resolved to IDs automatically.
    ...
    public AgentInfo createAgent(CreateAgentRequest.Builder builder) {
        ...
        EntityReference personaRef = EntityReference.builder()
                .id(personaInfo.getId())
                .type("persona")
                .build();
        ...
        if (abilityNames != null && !abilityNames.isEmpty()) {
            ...
            for (String abilityName : abilityNames) {
                ...
                EntityReference abilityRef = EntityReference.builder()
                        .id(abilityInfo.getId())
                        .type("ability")
                        .build();
     ...
     * @return the created agent information
     * @deprecated Use {@link #createAgent(CreateAgentRequest.Builder)} instead to automatically resolve persona and ability names
     */
    @Deprecated
