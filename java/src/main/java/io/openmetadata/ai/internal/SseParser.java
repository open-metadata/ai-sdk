...
public class SseParser {
     ...
     */
    public void parse(InputStream inputStream, Consumer<StreamEvent> eventConsumer) throws IOException {
    ...
    /**
     * Creates a Stream iterator for SSE events from an input stream.
    ...
    private StreamEvent parseEvent(String eventType, String data) {
        try {
            ...
            if (messageNode != null && messageNode.has("content") && messageNode.get("content").isArray()) {
