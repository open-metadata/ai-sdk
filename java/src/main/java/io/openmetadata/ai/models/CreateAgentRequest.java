...
public class CreateAgentRequest {
    ...
    public CreateAgentRequest(String name, String description, EntityReference persona, String mode,
                              String displayName, String icon, String botName, List<EntityReference> abilities,
                              KnowledgeScope knowledge, String prompt, String schedule,
                              boolean apiEnabled, String provider) {
        this.name = name;
    ...
    public static class Builder {
        ...
        public CreateAgentRequest build() {
            ...
            return new CreateAgentRequest(name, description, null, mode, displayName, icon,
                    botName, null, knowledge, prompt, schedule, apiEnabled, provider);
        }

        /**
         * Build the request with resolved entity references.
         * Used internally by MetadataAI.createAgent().
         */
        public CreateAgentRequest build(EntityReference persona, List<EntityReference> abilities) {
            ...
            return new CreateAgentRequest(name, description, persona, mode, displayName, icon,
                    botName, abilities, knowledge, prompt, schedule, apiEnabled, provider);
        }
    }
