...
public class IntegrationTest {
    ...
    class ConnectionTests {
        ...
        void testInvalidTokenRejected() {
            MetadataAI badClient = MetadataAI.builder()
    ...
    class AgentOperationsTests {
        ...
        void testGetAgentInfo() {
            ...
            System.out.println("Agent '" + testAgentName + "' info: " +
        ...
        void testInvokeAgent() {
            ...
            AgentHandle agent = client.agent(testAgentName);
            InvokeResponse response = agent.invoke("Hello, this is an integration test. Please respond briefly.");
        ...
        void testStreamAgent() {
            ...
            agent.stream("do we have any customer data", event -> {
            ...
            System.out.println("Streamed response: " + fullResponse.substring(0, Math.min(200, fullResponse.length())) + "...");
        }
        ...
        void testStreamIterator() {
            ...
            assertFalse(chunks.isEmpty());
            String fullResponse = String.join("", chunks);
            System.out.println("Streamed (iterator) response: " + fullResponse.substring(0, Math.min(200, fullResponse.length())) + "...");
        }
    }
    ...
    class PersonaOperationsTests {
        ...
        void testGetPersona() {
            ...
            System.out.println("Got persona: " + persona.getName() +
        ...
        void testGetPersonaNotFound() {
            assertThrows(PersonaNotFoundException.class,
                    () -> client.getPersona("non-existent-persona-12345"));
        }
    ...
    class BotOperationsTests {
        ...
        void testGetBot() {
            ...
            System.out.println("Got bot: " + bot.getName() +
        ...
        void testGetBotNotFound() {
            assertThrows(BotNotFoundException.class,
                    () -> client.getBot("non-existent-bot-12345"));
        }
    }
