...
class MetadataAITest {
    ...
    void agentInfoContainsExpectedFields() {
        AgentInfo info = new AgentInfo("test-agent", "Test Agent", "A test agent",
                Arrays.asList("ability1"), true);
    ...
    void personaInfoContainsExpectedFields() {
        PersonaInfo info = new PersonaInfo("persona-123", "test-persona", "Test Persona",
                "A test persona", "You are a helpful assistant", "system");
    ...
    void abilityInfoContainsExpectedFields() {
        AbilityInfo info = new AbilityInfo("ability-123", "test-ability", "Test Ability",
                "A test ability", "system", "test-ability-fqn", Arrays.asList("tool1", "tool2"));
    ...
    void createAgentRequestBuilderAcceptsValidModes() {
        // chat mode
        CreateAgentRequest chatRequest = CreateAgentRequest.builder()
                .name("test-agent")
                .description("A test agent")
                .persona("test-persona")
                .mode("chat")
        ...
        // both mode
        CreateAgentRequest bothRequest = CreateAgentRequest.builder()
                .name("test-agent")
                .description("A test agent")
                .persona("test-persona")
                .mode("both")
    ...
    void createAgentRequestCanBeBuiltWithAllFields() {
        KnowledgeScope knowledge = KnowledgeScope.builder()
    ...
    void knowledgeScopeCanBeBuilt() {
        EntityReference service = EntityReference.builder()
                .id("service-123")
    ...
    void entityReferenceCanBeBuilt() {
        EntityReference ref = EntityReference.builder()
                .id("entity-123")
                .type("persona")
                .name("test-entity")
