...
Usage:
    ...
    # Default invocation — banking-redshift defaults baked in.
    python create_context_center.py

    # Override the Redshift service / database for FQN resolution.
...
## Demo distribution (banking-redshift seeds)
...
The banking-redshift demo ships an engineered fraud burst: 10 customers × 80
...
""",
    ...
    ArticleSpec(
        ...
        display_name="dbt Model Layers (banking-redshift)",
...
The banking-redshift seed data ships eight intentional DQ defects so demos
...
MEMORIES: list[MemorySpec] = [
    ...
    MemorySpec(
        ...
        answer=(
            ...
            "detection rule.\n\n"
            "The engineered banking-redshift demo burst (10 customers × 80 "
    ...
    MemorySpec(
        ...
        answer=(
            ...
            "recalculation:\n\n"
            "```bash\n"
            "cd cookbook/resources/banking-redshift/dbt\n"
    ...
    MemorySpec(
        ...
        answer=(
            "The banking-redshift seed generator (`generate_seed_data.py`) "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "pages, memories) into OpenMetadata for the banking-redshift demo."
        )
    )
    parser.add_argument(
        "--host",
