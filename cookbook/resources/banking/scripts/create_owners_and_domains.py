...
membership to the banking demo database tables.
...
Usage:
    ...
    python create_owners_and_domains.py --service banking-bigquery --database my-gcp-project
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Seed OpenMetadata with users, domains, and table ownership for the banking demo."
    )
    parser.add_argument(
        "--host",
