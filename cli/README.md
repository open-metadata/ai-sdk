...
**TUI Features:**
- **Agent selection**: Type `/agents` or start without an agent to see available agents. The list always has **AskCollate (default)** at the top — pick it to chat with the platform's default agent. Press `Enter` to confirm.
